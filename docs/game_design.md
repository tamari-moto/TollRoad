...
レイヴンスパイアはどの王国都市とも王道では接続しておらず、往来は黒ゾーン経由のみ。ただし移動は最短経路で自動的に複数区間へまたがるため（6.3参照）、王道での迂回より黒ゾーンを2回経由した方が安い都市ペアも存在する。
...
| 黒ゾーン1区間（レイヴンスパイア発着） | 1日 | 400 | 22% |

実際の合計日数・費用・襲撃率は、最短経路に含まれる区間の合計になる。たとえば王道2区間なら2日・500・襲撃なし。黒ゾーンを2回経由する経路（王道での迂回より安い場合）なら2日・800・襲撃は2区間ぶん合成される（少なくとも1回被弾する確率 = 1 − 0.78²）。黒ゾーンはどの王国都市からレイヴンスパイアへ向かう場合も、またその逆も一律の条件となる。
